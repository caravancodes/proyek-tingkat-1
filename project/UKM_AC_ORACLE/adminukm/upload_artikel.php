				...
				<li class="text-center">
                    ...
                    <li >
						...
						<ul class="nav nav-second-level">
                            <li>
                                <a class="active-menu"  href="upload_artikel.php">Artikel</a>
                            </li>
                            <li>
                                ...
                                <div class="col-md-6">
                                    <form role="form" method="POST" enctype="multipart/form-data" action="">
                                        ...
                                        <div class="form-group">
											...
											<input type="hidden" name="gambarArtikel2" value="<?php echo "".$data->LOGO_UKM.""; ?>"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Isi Artikel</label>
                                            <textarea class="form-control" name="isiArtikel" rows="10"></textarea>
                                        </div>
	...
	if(isset($_POST['upload'])){
		...
		if($tipe_file == "image/jpeg" || $tipe_file == "image/jpg" || $tipe_file == "image/png"){
			if($ukuran_file <= 2000000){
				...
				$sql = "insert into posting values ('','$judul', '$nama_file_baru', '$tgl_up', '$isi2', '','','','','Artikel', 0,'$id')";
			...
			$sql = "insert into posting values ('','$judul', '$foto', '$tgl_up', '$isi2', '','','','','Artikel', 0,'$id')";
				$insert = oci_parse($conn,$sql);
                oci_execute($insert);
                if($insert==true){
					echo "<font color='blue'>Data berhasil ditambah</font>";
