...
font-size: 16px;"> <i class="glyphicon glyphicon-time"></i> &nbsp; &nbsp; <?php echo date("D, j F Y"); ?> &nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
           ...
           <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li >
                        <a class="active-menu" href=""><i class="fa fa-upload fa-3x"></i> Upload <span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							...
							<li>
                                <a class="active-menu" href="upload_pengurus.php">Pengurus UKM</a>
                            </li>
							<li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Upload Profil Pengurus UKM</h2>   
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <form role="form" action="" method="POST" enctype="multipart/form-data">
										...
										<div class="form-group">
                                            <label>NIM</label>
                                            <input class="form-control" type="text" placeholder="Masukkan NIM" name="nim" />
                                        </div>
                                        <div class="form-group">
                                            <label>Pilih Foto</label>
                                            <input type="file" name="foto"/>
											<p class="help-block">Upload Foto Profil.<br>Tipe file harus : jpeg/jpg/png</p>
                                        </div>
										<div class="form-group">
                                            <label>Jabatan</label>
                                            <input class="form-control" type="text" placeholder="Masukkan Jabatan" name="jabatan" />
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <input class="form-control" type="date" placeholder="yyyy-mm-dd" name="tgllahir" />
                                        </div>
										<div class="form-group">
                                            <label>Jurusan</label>
	...
	if(isset($_POST['upload'])){
		...
		if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){
			if($ukuran_file <= 2000000){
				...
				$sql = "INSERT into pengurus_ukm values ('$nim', '$nama_file_baru', '$nama', '$jabatan', '$biot', '$tempat','$tgl','$jurusan','$angkatan','$id','$jk')";
			...
			echo "<font color='red'>Maaf, anda belum memasukkan foto! tipe filenya harus jpg/png.</font>";
        }
    }
?>
                            </div>
